...
export default function SettingsPage() {
  ...
  return (
    <form
      ...
      className="space-y-6 animate-in fade-in duration-500 max-w-6xl mx-auto"
    >
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Configure site variables, integrations and branding
          </p>
        </div>
        <Button
          size="lg"
      ...
      <Tabs defaultValue="general" className="w-full">
        ...
        <div className="mt-6">
                ...
                <div className="space-y-3">
                  <Label>
                    ...
                    <span className="text-[10px] text-slate-400 font-normal ml-1">
                      (white/light – transparent header)
                    </span>
                  </Label>
                  ...
                  <p className="text-[10px] text-slate-400">
                    Transparent PNG/SVG with white/light content
                  </p>
                </div>
                  ...
                  <div className="aspect-video border-2 border-dashed rounded-xl bg-slate-50 flex items-center justify-center relative overflow-hidden group">
                    ...
                    <label className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer transition-opacity">
                      ...
                      <Input
                        type="file"
                        className="hidden"
                        onChange={(e) => handleFileChange("site_dark_logo", e)}
                      />
                    </label>
                  </div>
                  <p className="text-[10px] text-slate-400">
                    Transparent PNG/SVG with dark/black content
                  </p>
                </div>
          ...
          <TabsContent value="smtp" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Required for system notifications and user emails
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange("seo_meta_title", e.target.value)
                    }
                  />
                </div>
                <div className="grid gap-2">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(val) =>
                      handleChange("stripe_enabled", val ? "1" : "0")
                    }
                  />
                </div>
                <CardDescription>
                  Secure payment processing settings
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(val) => handleChange("stripe_mode", val)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
          ...
          <TabsContent value="cart" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Checkout & Cart Behavior</CardTitle>
              </CardHeader>
                ...
                <div className="flex items-center justify-between p-4 border rounded-xl bg-slate-50/50">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Enable site-wide shopping cart
                    </p>
                  </div>
                  <Switch
                    checked={settings.cart_enabled === "1"}
                    onCheckedChange={(val) =>
                      handleChange("cart_enabled", val ? "1" : "0")
                    }
                  />
                </div>
                <div className="flex items-center justify-between p-4 border rounded-xl bg-slate-50/50">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Allow users to checkout without accounts
                    </p>
                  </div>
                  <Switch
                    checked={settings.guest_checkout_enabled === "1"}
                    onCheckedChange={(val) =>
                      handleChange("guest_checkout_enabled", val ? "1" : "0")
                    }
                  />
                </div>
                <div className="grid grid-cols-2 gap-4">
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      />
                      <p className="text-[10px] text-slate-400">
                        Set to 0 to always charge, or high value to disable free
                        shipping
                      </p>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <Textarea
                    ...
                    placeholder="<!-- Meta pixels, external libs -->"
                  />
                </div>
                <div className="grid gap-2">
                  ...
                  <Textarea
                    ...
                    className="font-mono text-xs h-32"
                    placeholder="<!-- Chat widgets, analytics -->"
                  />
                </div>
              </CardContent>
            </Card>
