                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="p-6 border-b border-slate-800 flex items-center justify-between">
                        <Link to="/admin" className="flex items-center gap-3 group">
                            ...
                            <span className="font-bold text-xl tracking-tight">Cruzaa Admin</span>
                        </Link>
                    </div>
                    ...
                    <div className="p-4 border-t border-slate-800 mt-auto">
                        <div className="flex items-center gap-3 px-2 py-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-slate-400 truncate opacity-70 capitalize">{user?.role || 'Administrator'}</p>
                            </div>
                            <Button size="icon" variant="ghost" className="text-slate-400 hover:text-red-400 hover:bg-slate-800" onClick={logout}>
                ...
                <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-8 z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-lg font-semibold text-slate-800 capitalize">
                            {sidebarItems.find(item => location.pathname === item.path || (item.path !== '/admin' && location.pathname.startsWith(item.path)))?.label || 'Dashboard'}
                        </h2>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-56 mt-1 shadow-xl">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem onClick={logout} className="text-red-500 hover:bg-red-50 cursor-pointer">
